...
public class UniversityListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //Java Backend
//        getServletContext().getRequestDispatcher("/universityList.jsp").forward(req, resp);//отправляем в отображатель
        getServletContext().getRequestDispatcher("/universityList_jstl.jsp").forward(req, resp);//отправляем в отображатель
    }
}
